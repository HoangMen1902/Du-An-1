    ...
    <div class="col-xl-6 grid-margin stretch-card flex-column">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div>
                                <p class="mb-2 text-muted">Số lượt xem</p>
                                <h6 class="mb-0"></h6>
                            </div>
                            <div>
                                <p class="mb-2 text-muted"></p>
                            ...
                            <div class="text-center" style="width: fit-content;">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 w-50" width="60px">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 3C7.5 3 3.72 6.08 2.25 10.5 3.72 14.92 7.5 18 12 18s8.28-3.08 9.75-7.5C20.28 6.08 16.5 3 12 3z" />
        ...
        <div class="row h-100">
            <!-- <div class="col-md-6 stretch-card grid-margin grid-margin-md-0">
                        <div class="card">
                            <div class="card-body d-flex flex-column justify-content-between">
                                <p class="text-muted">Đơn hàng</p> <h3 class="mb-">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="row h-100">
                                    ...
                                    <div class="col-6 d-flex flex-column justify-content-between">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-6 w-50">
