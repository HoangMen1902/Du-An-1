...
<script
  ...
  crossorigin="anonymous"></script>
    ...
    <script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v21.0&appId=588410296952063"></script>
    <header class="header">
        ...
        <div class="icon-group">
            ...
            <a href="<?=isset($_SESSION['user']) ? '/profile' : '/login'?>"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.0"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                </svg></a>

            <a href="/cart"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.0"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="list-responsive">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-6" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
    ...
    <footer>
        <div class="container-fluid custom-height bg-black">
            <div class="row">
                <img class="logo-footer" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/Images/Home/logo_footer.png"
                    alt="">
            </div>
            <div class="row">
                <div class="col-xl-3 col-md-6 mt-3">
                    <div class="content">
                        ...
                        <div class="card-text text-white d-flex align-items-center mb-2 ms-3">
                            <svg xmlns="http://www.w3.org/2000/svg" height="15px" ; filter="invert(100%)"
                                viewBox="0 0 512 512">
                                <path
                ...
                <div class="col-xl-3 col-md-6 mt-3">
                    <div class="card-title text-white mb-3">
                        ...
                        <div class="fb-page" data-href="https://www.facebook.com/profile.php?id=61566409141457"
                            data-tabs="timeline" data-width="200" data-height="100" data-small-header="false"
                            data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="https://www.facebook.com/profile.php?id=61566409141457"
                                class="fb-xfbml-parse-ignore"><a
                                    href="https://www.facebook.com/profile.php?id=61566409141457">Bee Technova</a>
                            </blockquote>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white custom-h2 d-flex align-items-center">
            ...
            <div class="col-xl-6 col-md-6 text-end pe-5 ">
                <img class="icon-bank" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/Images/Home/Overlay.png"
                    alt="">
                <img class="icon-bank" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/Images/Home/Overlay1.png"
                    alt="">
                <img class="icon-bank" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/Images/Home/Overlay2.png"
                    alt="">
                <img class="icon-bank" src="<?= $_ENV['APP_URL'] ?>/public/Assets/Client/Images/Home/Overlay3.png"
                    alt="">
            </div>
        </div>
    </footer>
