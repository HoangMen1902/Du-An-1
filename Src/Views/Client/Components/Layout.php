    ...
    <footer>
            <div class="container-fluid custom-height bg-black">
                <div class="row">
                    <div class="col-xl-3 col-md-6 mt-3">
                        <img src="<?=$_ENV['APP_URL']?>/public/Assets/Client/Images/Home/logo_footer.png" alt="">
                        <div class="content">
            ...
            <div class="bg-white custom-h2 d-flex align-items-center">
                ...
                <div class="col-xl-6 col-md-6 text-end pe-5 ">
                    <img src="<?=$_ENV['APP_URL']?>/public/Assets/Client/Images/Home/Overlay.png" alt="">
                    <img src="<?=$_ENV['APP_URL']?>/public/Assets/Client/Images/Home/Overlay1.png" alt="">
                    <img src="<?=$_ENV['APP_URL']?>/public/Assets/Client/Images/Home/Overlay2.png" alt="">
