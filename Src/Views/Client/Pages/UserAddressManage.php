...
?>
        ...
        <section class="account">
            <div class="container-fluid">
                <div class="row g-0">
                    <?php $this->Insert('Client/Pages/UserProfile/Particals/sidebar'); ?>
                                    ...
                                    ?>
                                        <div class="address">
                                            <h4 class="address__name d-flex gap-1 align-items-center">
                                                ...
                                                <form action="/my-account/delete-address" method="post">
                                            ...
                                            SĐT: <?= empty($data['phone']) === true ? 'Vui lòng cập nhật SĐT ở trang thông tin cá nhân' : $data['phone'] ?>
                                            </p>
                                            <p>Tỉnh/thành: <?= $data['province_name'] ?></p>
                                            <p>Quận/Huyện: <?= $data['district_name'] ?></p>
                                            <p>Phường/Xã: <?= $data['ward_name'] ?></p>
                                            <p class="mb-0">
                                                Địa chỉ chi tiết:
                                                <?= $data['address'] ?>
                                            </p>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="addressForm" method="post" action="/change-user-address">
                                                            ...
                                                            <div class="form-group text-start">
                                                                <label for="" class="form-label">Địa chỉ chi tiết</label>
                                                                <input type="text" class="form-control p-3" name="address" id="address" value="<?= $data['address'] ?>">
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="modal-footer">
