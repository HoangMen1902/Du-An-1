...
final class InstallmentPlans extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table->addColumn('order_id', 'integer', ['null' => false, 'signed' => false])
            ...
            ->addColumn('down_payment_rate', 'decimal', ['precision' => 5, 'scale' => 2, 'null' => false]) 
            ->addColumn('status', 'tinyinteger', ['default' => 1, 'null' => false]) 
